...
contract HBTCIPFSRendererTest is Test {
    HBTCIPFSRenderer private renderer;
    ...
    function test_MapsRepresentativeTokenIdsToCanonicalIPFSImages() public view {
        assertEq(renderer.imageURI(1), "ipfs://bafybeid5mf357emmvvhw7gm2k44k3li2ayure7zkh6zpl7hptqbx5ih6vy/0001.png");
        assertEq(renderer.imageURI(100), "ipfs://bafybeid5mf357emmvvhw7gm2k44k3li2ayure7zkh6zpl7hptqbx5ih6vy/0100.png");
        assertEq(
            renderer.imageURI(1_000), "ipfs://bafybeid5mf357emmvvhw7gm2k44k3li2ayure7zkh6zpl7hptqbx5ih6vy/1000.png"
        );
    }
    ...
    function test_TokenURIContainsOnchainMetadataAndCanonicalIPFSImage() public view {
        ...
        assertEq(vm.parseJsonString(json, ".name"), "HBTC #1");
        assertEq(vm.parseJsonString(json, ".description"), "HBTC NFT Collection");
        assertEq(
            vm.parseJsonString(json, ".image"),
            "ipfs://bafybeid5mf357emmvvhw7gm2k44k3li2ayure7zkh6zpl7hptqbx5ih6vy/0001.png"
        );
        assertEq(vm.parseJson(json, ".attributes"), abi.encode(new bytes[](0)));
        assertFalse(_contains(json, "gateway.pinata.cloud"));
    }
    ...
    function test_RenderSVGUsesFileSpecificHTTPSGatewayFallback() public view {
        ...
        assertTrue(
            _contains(
                svg,
                "https://gateway.pinata.cloud/ipfs/bafybeid5mf357emmvvhw7gm2k44k3li2ayure7zkh6zpl7hptqbx5ih6vy/0001.png"
            )
        );
    ...
    function test_ContractURIUsesCollectionNameAndCanonicalIPFSImage() public view {
        string memory json = _decodeDataURI(renderer.renderContractURI("HBTC"));

        assertEq(vm.parseJsonString(json, ".name"), "HBTC");
        assertEq(vm.parseJsonString(json, ".description"), "HBTC NFT Collection");
        assertEq(
            vm.parseJsonString(json, ".image"),
            "ipfs://bafybeid5mf357emmvvhw7gm2k44k3li2ayure7zkh6zpl7hptqbx5ih6vy/0001.png"
    ...
    function test_RevertsForTokenIdZero() public {
        vm.expectRevert(abi.encodeWithSelector(HBTCIPFSRenderer.InvalidTokenId.selector, 0));
        renderer.fileName(0);
    }

    function test_RevertsAboveCollectionSupply() public {
        vm.expectRevert(abi.encodeWithSelector(HBTCIPFSRenderer.InvalidTokenId.selector, 1_001));
        renderer.renderTokenURI(_params(1_001));
    }
